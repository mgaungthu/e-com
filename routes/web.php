    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::prefix('admin')->group(function () {
            ...
            */
            ...
            Route::get('/payment-methods/{paymentMethod}', [PaymentMethodController::class, 'show'])->name('admin.payment-methods.show');
...
*/
            ...
            /*
             * POST is intentionally used for updates because payment method
             * updates may contain multipart/form-data for logo and QR images.
             */
            Route::post('/payment-methods/{paymentMethod}', [PaymentMethodController::class, 'update'])->name('admin.payment-methods.update');
            ...
            */
            ...
            Route::get('/home-banners', [HomeBannerController::class, 'index'])->name('admin.home-banners.index');

            Route::post('/home-banners', [HomeBannerController::class, 'store'])->name('admin.home-banners.store');

            Route::get('/home-banners/{homeBanner}', [HomeBannerController::class, 'show'])->name('admin.home-banners.show');

            /*
             * POST is intentionally used for updates because banner updates
             * may contain multipart/form-data with a new artwork image.
             */
            Route::post('/home-banners/{homeBanner}', [HomeBannerController::class, 'update'])->name('admin.home-banners.update');

            Route::delete('/home-banners/{homeBanner}', [HomeBannerController::class, 'destroy'])->name('admin.home-banners.destroy');
