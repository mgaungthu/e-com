...
Route::domain(
    ...
    Route::middleware('auth')->group(function () {
        Route::get(
            '/admin/me',
            [AuthenticatedSessionController::class, 'me']
        )->name('admin.me');
        ...
        Route::prefix('admin')->group(function () {
            ...
            */
            ...
            Route::get(
                '/home-banners',
                [HomeBannerController::class, 'index']
            )->name('admin.home-banners.index');

            Route::post(
                '/home-banners',
                [HomeBannerController::class, 'store']
            )->name('admin.home-banners.store');

            Route::get(
                '/home-banners/{homeBanner}',
                [HomeBannerController::class, 'show']
            )->name('admin.home-banners.show');
            ...
            Route::post(
                '/home-banners/{homeBanner}',
                [HomeBannerController::class, 'update']
            )->name('admin.home-banners.update');

            Route::delete(
                '/home-banners/{homeBanner}',
                [HomeBannerController::class, 'destroy']
            )->name('admin.home-banners.destroy');
            ...
            */
            ...
            )->name('admin.feeds.update');

            Route::delete(
                '/feeds/{feed}',
                [FeedController::class, 'destroy']
            )->name('admin.feeds.destroy');
            ...
            */
            ...
            )->name('admin.customers.status.update');

            Route::post(
                '/customers/{customer}/notes',
                [CustomerNoteController::class, 'store']
            )->name('admin.customers.notes.store');

            Route::patch(
                '/customers/{customer}/notes/{note}',
                [CustomerNoteController::class, 'update']
            )->name('admin.customers.notes.update');

            Route::delete(
                '/customers/{customer}/notes/{note}',
                [CustomerNoteController::class, 'destroy']
